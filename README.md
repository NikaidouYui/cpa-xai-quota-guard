...
CLIProxyAPI **原生 Go 插件**（当前版本 **0.3.6**）：仅针对 **xAI** 登录凭证做额度/死号管控、主动巡查、管理 UI 与用量统计。


## 界面预览

管理页示意（0.3.1 起与线上简洁风格对齐；脱敏真实截图见 [docs/screenshots/README.md](./docs/screenshots/README.md)）：
