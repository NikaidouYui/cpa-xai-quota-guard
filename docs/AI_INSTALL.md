...
Release 下载（官方）：
https://github.com/NikaidouYui/cpa-xai-quota-guard/releases/download/v0.3.13/<资产名>

加速示例（可选）：
https://ghproxy.com/https://github.com/NikaidouYui/cpa-xai-quota-guard/releases/download/v0.3.13/<资产名>
...
- Releases：https://github.com/NikaidouYui/cpa-xai-quota-guard/releases/tag/v0.3.13  
- 仓库：https://github.com/NikaidouYui/cpa-xai-quota-guard  
